...
if __name__ == '__main__':
    file_name = "test.wav"
    subprocess.run(["venv/Scripts/python.exe", "evaluation/m_inference.py", "-f_wav", file_name, "-d_wav", "input", "-f_config", "corpus/config.json", "-d_fe", "corpus/feature", "-d_cp", "checkpoint/MAESTRO-V3", "-m", "model_016_003.pkl", "-d_mpe", "output", "-d_note", "output", "-calc_transcript", "-calc_feature", "-mode", "combination"])
